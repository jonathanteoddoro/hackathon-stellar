        ...
        <div className="text-center max-w-3xl mx-auto">
          <BlurFade delay={500}>
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 font-suisse leading-tight">
              Making DeFi on <span className="font-bold">Stellar</span>
              <br />
              <span className="font-light">Accessible</span>,{" "}
              <span className="font-light">easy</span> and{" "}
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-8 font-suisse font-light max-w-xl mx-auto leading-relaxed">
            A low-code platform empowering any developer to integrate DeFi into
            their apps.
          </p>
